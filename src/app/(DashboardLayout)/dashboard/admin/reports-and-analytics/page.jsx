    ...
    <section>
      ...
      <div className='flex flex-col-reverse md:flex-col'>
        <div className='space-y-4 mt-4'>
          ...
          <div className='w-2/3 flex bg-white pr-8 py-8 rounded-lg shadow-md gap-8'>
              ...
              isLoading ?
                ...
                <>
                  {metricCards.map(({ label, unit, getValue, getTrend, getUp }, i) => {
                    ...
                    const up = getUp(d);
                    return (
                      <div key={label} className="relative bg-white rounded-lg p-3 md:p-4 lg:p-6 shadow-md overflow-hidden">
