...
import { CheckCircle, Search, ShoppingCart, Store } from 'lucide-react';
            ...
            <div className="group">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-green-200 p-8 md:p-12 hover:border-green-400 hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105">
                <div className="text-center">
                  ...
                  <Button className="cursor-pointer w-full py-4 text-lg bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-blue-500/25">
                    Start Shopping 🛒
                  </Button>
                </div>
              </div>
            ...
            <div className="group">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-green-200 p-8 md:p-12 hover:border-green-400 hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105">
                <div className="text-center">
                  ...
                  <Link href={"/our-services/sell-post"}>
                    <Button className="cursor-pointer w-full py-4 text-lg bg-linear-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-green-500/25">
                      Start Selling 💰
                    </Button>
                  </Link>
                </div>
