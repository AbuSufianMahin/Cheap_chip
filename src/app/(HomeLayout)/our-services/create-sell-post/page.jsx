...
import { apiCallJson, getApiBaseUrl } from '@/lib/apiClient';
...
function CreateSellPost() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log('[CreateSellPost] Submitting to:', `${apiBaseUrl}/api/product-lifecycle/create`);
      ...
      console.log('[CreateSellPost] Response status:', response.status);
      const result = await response.json();
      console.log('[CreateSellPost] Response data:', result);
      ...
      console.error('[CreateSellPost] Error:', error);
      setErrorMessage(error.message || 'Failed to create sell post. Make sure the backend server is running.');
    } finally {
      setLoading(false);
    }
  };
